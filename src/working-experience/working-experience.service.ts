...
import { UpdateWorkingExperienceInput, UpdateWorkingExperienceOutput } from './dto/update-working-experience.dto';
...
export class WorkingExperienceService {
  ...
  async update(user:User, id: number, UpdateWorkingExperienceInput: UpdateWorkingExperienceInput): Promise<UpdateWorkingExperienceOutput> {
    try{
      await this.workingExperience.save({id,...UpdateWorkingExperienceInput})
